...
void generate_calendar(const int year, string filename, const std::vector<std::wstring>& months_names, const std::vector<std::wstring>& day_of_week, const int height) {
